...
if(NOT HDF5_FOUND AND NOT HDF5_ROOT)
    find_package(HDF5 ${PACKAGE_FIND_VERSION} QUIET NO_MODULE)
    if( HDF5_FOUND)
        ...
        foreach(_lang ${HDF5_LANGUAGE_BINDINGS})
            ...
            # message(STATUS "Trying target ${HDF5_${_lang}_TARGET}${_suffix}")
            ...
            # Find compiler definitions from the target
            get_target_property(_lang_defs ${HDF5_${_lang}_TARGET}${_suffix} INTERFACE_COMPILE_DEFINITIONS)
            if (_lang_defs)
                set(HDF5_DEFINITIONS "${HDF5_DEFINITIONS} -D${_lang_defs}")
            endif()
            ...
            if( _lang_location )
                set(HDF5_${_lang}_LIBRARY ${_lang_location} CACHE FILEPATH
                    "HDF5 ${_lang} library" )
            ...
            get_target_property(HDF5_${_lang}_INCLUDE_DIR ${HDF5_${_lang}_TARGET}${_suffix} INTERFACE_INCLUDE_DIRECTORIES)
        endforeach()
    endif()
...
set(HDF5_DEFINITIONS "${HDF5_DEFINITIONS}" CACHE STRING "compiler definitions for HDF5")
